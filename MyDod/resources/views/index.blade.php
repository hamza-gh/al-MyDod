                      ...
                      @auth
                          @if(Auth::user()->etat=='user')
                            <div>
                                ...
                                <a href="{{ url('/profil') }}" class="ml-4 text-sm text-gray-700 underline">{{Auth::user()->name}}</a>
                                    <a href="/deconnexion" class="ml-4 text-sm text-gray-700 underline">Deconnexion</a>
                            </div>

                            
                             </div>
                                    <div>
                                        <a class="btn btn-danger" style="color: #edf2f7;">Incident</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                        <a href="/liste_incident" class="btn btn-danger">liste incident</a><br><br><br><br><br><br>
                                        <a class="btn btn-danger" style="color: #edf2f7;" >EB =>Sharepoint</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <a href="/l_d_droit" class="btn btn-danger">Vos Demande de droit</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <a href="/ll_d_droit" class="btn btn-danger">liste des demandes de droits</a>
                                        </div>
                                    ...
                                    <!-- login button -->
                                    <div class="container">
                                    <a > Hello Admin </a> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
