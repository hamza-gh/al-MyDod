...
<body background="{{asset('assets\img\header.png')}}">
    <div id="app" style="left: 200px;">
        <nav class="navbar navbar-expand-md  shadow-sm" style="background: black; position: relative;">
            <div class="container" >
            <img src="{{asset('assets\img\al.png')}}" id="icon" alt="User Icon"  style="width: 60px;"/> &nbsp;&nbsp;&nbsp;
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <a href="/in_list" style="font-weight: bolder; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-size: 13px; text-align: center;">Incident</a>
                      <!--  <a href="#">Link 2</a>-->
